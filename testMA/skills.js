...
document.addEventListener('DOMContentLoaded', function() {
  ...
  let classes = {};
  console.log('Fetching classes from the database...');
  database.ref('/classes').once('value', function(snapshot) {
    ...
    function generateSkillsTable(currentUser, userClasses) {
      console.log('Generating skills table for the current user:', currentUser);
  ...
  firebase.auth().onAuthStateChanged(function(user) {
    if (user) {
      ...
      database.ref('/users/' + uid).once('value', function(snapshot) {
        ...
        generateSkillsTable(currentUser, userClasses);
